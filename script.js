...
function animateComputer(
  ...
  function animate(classes, finalBtn) {
    // *Recursive loop makes setTimeout work in real time
    ...
    setTimeout(() => {
      ...
      i++; // Increment counter
      if (i < iterations) {
        // If we have not finished all iterations,
        animate(classes, finalBtn); // *Recursion: iterate
      } else {
        // If we have finished all iterations,
...
function announceResult(result) {
  ...
  centreDiv.style.animation = '';
  flashText(centreDiv); // Declared below

  function flashText(node) {
    // Recursive
    setTimeout(() => {
      ...
      setTimeout(() => {
        ...
        setTimeout(() => {
          ...
          setTimeout(() => {
            ...
            setTimeout(() => {
              centreDiv.style.visibility = 'visible';
              centreDiv.style.animation = 'mymove 1s 1';
            }, secondaryDelay);
          }, secondaryDelay);
        }, secondaryDelay);
      }, secondaryDelay);
